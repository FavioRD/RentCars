...
<body>
	<!-- Sidebar -->
	<nav class="d-flex flex-column bg-light shadow-sm"
		...
		<ul class="nav flex-column px-2 flex-grow-1">
			...
			<li class="nav-item mt-3">
				<h6 class="text-uppercase text-secondary px-2">Mantenimiento
					Auto</h6>
			</li>
			<li class="nav-item"><a href="autos?action=agregarAuto"
				class="nav-link text-dark ps-3"> <i
					class="bi bi-plus-circle me-2"></i> Agregar Auto
			</a></li>
			<li class="nav-item"><a href="#" class="nav-link text-dark ps-3">
					<i class="bi bi-trash me-2"></i> Borrar Auto
			</a></li>
			<li class="nav-item"><a
				href="${pageContext.request.contextPath}/autos?action=verAutos"
				class="nav-link text-dark ps-3"> <i class="bi bi-list-task me-2"></i>
					Listar Autos
			</a></li>
			<%
			}
			...
			<li class="nav-item"><a href="autos?action=verAlquilados"
				class="nav-link text-dark ps-3"> <i class="bi bi-eye me-2"></i>
					Ver Autos Alquilados
			</a></li>
			...
			<li class="nav-item"><a
				...
				class="nav-link text-dark ps-3"> <i class="bi bi-people me-2"></i>
					Mantenimiento Clientes
			</a></li>
			<li class="nav-item"><a
				href="${pageContext.request.contextPath}/cliente?action=agregarCliente"
				class="nav-link text-dark ps-3"> <i
					class="bi bi-person-plus-fill me-2"></i> Agregar Cliente
			</a></li>
			...
			<li class="nav-item"><a
				...
				class="nav-link text-dark ps-3"> <i
					class="bi bi-speedometer2 me-2"></i> Autos con más Kilometraje
			</a></li>
			<li class="nav-item"><a href="cliente?action=reporteClientes"
				class="nav-link text-dark ps-3"> <i class="bi bi-bar-chart me-2"></i>
